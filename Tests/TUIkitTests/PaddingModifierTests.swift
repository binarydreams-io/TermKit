...
struct PaddingModifierTests {
  ...
  @Test("Padding translates interaction regions")
  func paddingTranslatesRegions() {
    let modifier = PaddingModifier(insets: EdgeInsets(top: 1, leading: 2, bottom: 3, trailing: 4))
    let buffer = FrameBuffer(
      text: "Hi",
