...
struct SyntaxHighlightingTests {
    @Test("Subtle highlighter recognizes common lexical tokens")
    func lexicalTokens() {
    ...
    @Test("Changed ranges expand to complete lines")
    func changedLines() throws {
    ...
    @Test("Plain highlighter preserves readable code")
    func plainFallback() {
