...
struct TextEditorTests {
  @Test
  func `Paste replaces the selected range and preserves line breaks`() {
  ...
  @Test
  func `Newline editing and submit are separate commands`() {
  ...
  @Test
  func `Vertical movement clamps the column to each target line`() {
  ...
  @Test
  func `Documents normalize CRLF and CR line endings`() {
