...
struct DamageAndPaintTests {
    ...
    @Test func damageTrackerUnionsOverlappingRects() {
    ...
    @Test func damageTrackerClipsToBounds() {
    ...
    @Test func paintContextCombinesOriginClipOpacityAndZIndex() throws {
    ...
    #if DEBUG
    @Test func nestedClipScopesRestoreTheirSharedDepth() {
