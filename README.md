...
Version `0.1.0` supports Swift 6.3.3, macOS 14 or later, and glibc-based Linux systems.
...
Network image loading and animated PNG are not part of version 0.1.0.
