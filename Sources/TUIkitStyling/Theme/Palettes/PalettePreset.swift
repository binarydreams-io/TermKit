...
extension SystemPalette {
  ...
  fileprivate struct Tuning {
    /// Base
    let baseHue, bgSaturation, barSaturation: Double
    // Foreground
    let fgHue, fgSaturation, fgLightness: Double
    let fgSecSaturation, fgSecLightness: Double
    let fgTerSaturation, fgTerLightness: Double
    let fgQuatSaturation, fgQuatLightness: Double
    // Accent
    let accentHue, accentSaturation, accentLightness: Double
    // Semantic
    let successHue, successSaturation, successLightness: Double
    let warningHue, warningSaturation, warningLightness: Double
    let errorHue, errorSaturation, errorLightness: Double
    let infoHue, infoSaturation, infoLightness: Double
    // Border
    let borderSaturation, borderLightness: Double
    /// Focus background
    let focusBgLightness: Double
    // Cursor
    let cursorHue, cursorSaturation, cursorLightness: Double
  }
}
...
extension SystemPalette.Tuning {
  ...
  fileprivate static var greenTuning: SystemPalette.Tuning {
  ...
  fileprivate static var amberTuning: SystemPalette.Tuning {
    SystemPalette.Tuning(
  ...
  fileprivate static var redTuning: SystemPalette.Tuning {
    SystemPalette.Tuning(
  ...
  fileprivate static var violetTuning: SystemPalette.Tuning {
    SystemPalette.Tuning(
  ...
  fileprivate static var blueTuning: SystemPalette.Tuning {
    SystemPalette.Tuning(
  ...
  fileprivate static var whiteTuning: SystemPalette.Tuning {
    SystemPalette.Tuning(
