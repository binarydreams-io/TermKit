...
func presentationValueIsFinite<Value: VectorArithmetic>(_ value: Value) -> Bool {
    switch value {
...
extension PresentationProperty where Value == LinearRGBA {
    ...
    public static var foregroundColor: Self { PresentationProperties.foregroundColor }
    /// The standard background color property.
    public static var backgroundColor: Self { PresentationProperties.backgroundColor }
    /// The standard border color property.
    public static var borderColor: Self { PresentationProperties.borderColor }
    /// The standard selection highlight property.
    public static var selectionHighlight: Self { PresentationProperties.selectionHighlight }
    /// The standard focus highlight property.
    public static var focusHighlight: Self { PresentationProperties.focusHighlight }
}

extension PresentationProperty where Value == Double {
    /// The standard opacity property.
    public static var opacity: Self { PresentationProperties.opacity }
    /// The standard frame width property.
    public static var frameWidth: Self { PresentationProperties.frameWidth }
    /// The standard frame height property.
    public static var frameHeight: Self { PresentationProperties.frameHeight }
    /// The standard spacing property.
    public static var spacing: Self { PresentationProperties.spacing }
    /// The standard clip reveal property.
    public static var clipReveal: Self { PresentationProperties.clipReveal }
    /// The standard transition visibility property.
    public static var transitionVisibility: Self { PresentationProperties.transitionVisibility }
}

extension PresentationProperty where Value == CellVector {
    /// The standard cell offset property.
    public static var offset: Self { PresentationProperties.offset }
    /// The standard scroll position property.
    public static var scrollPosition: Self { PresentationProperties.scrollPosition }
}

extension PresentationProperty where Value == FloatingEdgeInsets {
    /// The standard padding property.
    public static var padding: Self { PresentationProperties.padding }
    /// The standard clip inset property.
    public static var clipInsets: Self { PresentationProperties.clipInsets }
}
