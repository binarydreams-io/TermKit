...
private struct TransitionAttribute: MountedNodeAttribute {
  ...
  var id: AnyHashable {
    ObjectIdentifier(TransitionAttributeID.self)
  }
...
extension View {
  ...
  /// - Complexity: O(1).
  public func animation(_ animation: Animation?, value: some Hashable & Sendable) -> some View {
...
extension NodeDescriptor {
  ...
  /// - Complexity: O(1).
  @MainActor
  public func animatableValue(
    _ value: some VectorArithmetic,
...
extension MountedNode {
  ...
  /// - Complexity: O(1) on average.
  public func animationStatus(for property: PresentationProperty<some VectorArithmetic>) -> AnimationTrackStatus? {
