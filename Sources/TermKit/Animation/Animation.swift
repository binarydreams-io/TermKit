...
extension Animation {
  ...
  func springMotionSample(at elapsed: TimeSpan) -> SpringMotionSample? {
    guard case let .spring(response, dampingFraction) = curve else { return nil }
  ...
  private func bezier(_ parameter: Double, control1: Double, control2: Double) -> Double {
  ...
  private func bezierDerivative(_ parameter: Double, control1: Double, control2: Double) -> Double {
    let inverse = 1 - parameter
  ...
  private func springMotionSample(
    at time: Double,
    responseSeconds: Double,
    dampingFraction: Double
  ) -> SpringMotionSample {
