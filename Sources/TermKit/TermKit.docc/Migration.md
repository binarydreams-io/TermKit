...
TermKit 2.1.0 uses one `TermKit` library product and one `TermKit` module.

## Historical context

Earlier development versions split the package into several modules and used different product names. Those interfaces are not part of TermKit 2.1.0.
