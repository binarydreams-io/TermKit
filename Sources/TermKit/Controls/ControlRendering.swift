...
public struct Text: SemanticRenderable, View, Hashable {
  ...
  public nonisolated init(_ text: String, id: SemanticID = "text", style: CellStyle = .default) {
    self.init(runs: [StyledRun(text, style: style)], id: id)
  }

  /// Creates text from styled segments.
  public nonisolated init(runs: [StyledRun], id: SemanticID = "text") {
    self.id = id
    self.runs = runs
  }
  ...
  public nonisolated var plainText: String {
