...
public final class TerminalEventSource: Sendable {
  ...
  public init(inputFileDescriptor: Int32 = STDIN_FILENO) throws {
    self.owner = try TerminalEventSourcePOSIXOwner.make(inputFileDescriptor: inputFileDescriptor)
  }
...
#if canImport(Darwin)
private nonisolated(unsafe) var terminalSignalWriteFileDescriptor: Int32 = -1
private nonisolated(unsafe) var terminalSignalActiveHandlerCount: Int32 = 0
private nonisolated(unsafe) var terminalSignalPendingBits: Int32 = 0
#else
...
private final class TerminalEventSourcePOSIXOwner: @unchecked Sendable {
  ...
  static func make(inputFileDescriptor: Int32) throws -> TerminalEventSourcePOSIXOwner {
    ...
    do {
      ...
      for signalNumber in terminalManagedSignals {
        try registrations.append(installHandler(for: signalNumber))
      }
      ...
      while true {
        ...
        if result == 0 {
          if timeout != nil {
            ...
            if try monotonicNanoseconds() >= deadline {
              return nil
            }
          }
          continue
  ...
  func fillSelfPipeForTesting() throws {
    let bytes = [UInt8](repeating: UInt8.max, count: 1024)
    while true {
...
private func pollTimeoutMilliseconds(
  ...
  let milliseconds =
    remainingNanoseconds / 1000000
      + (remainingNanoseconds.isMultiple(of: 1000000) ? 0 : 1)
