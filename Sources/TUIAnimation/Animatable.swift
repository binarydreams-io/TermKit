...
where Modifier.Content == Content, Modifier.Body: View {
    ...
    var graphBody: [NodeDescriptor] {
        ...
        let descriptor = NodeDescriptor.declarative(AnimatableModifierBody(content: content, box: box))
            .attribute(attribute)
...
public extension View {
    ...
    func modifier<Modifier: AnimatableModifier>(_ modifier: Modifier) -> some View
