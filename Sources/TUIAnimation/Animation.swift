...
public enum AnimationCurve: Sendable, Hashable {
    ...
    case spring(response: TUIDuration, dampingFraction: Double)
}
...
public struct Animation: Sendable, Hashable {
    ...
    public static func linear(duration: TUIDuration = .milliseconds(350)) -> Animation {
        Animation(curve: .linear, duration: duration)
    }

    public static func easeIn(duration: TUIDuration = .milliseconds(350)) -> Animation {
        cubicBezier(0.42, 0, 1, 1, duration: duration)
    }

    public static func easeOut(duration: TUIDuration = .milliseconds(350)) -> Animation {
        cubicBezier(0, 0, 0.58, 1, duration: duration)
    }

    public static func easeInOut(duration: TUIDuration = .milliseconds(350)) -> Animation {
    ...
    public static func cubicBezier(
        ...
        _ x2: Double,
        _ y2: Double,
        duration: TUIDuration = .milliseconds(350)
    ) -> Animation {
    ...
    public static func spring(
        response: TUIDuration = .milliseconds(500),
    ...
    public init(curve: AnimationCurve, duration: TUIDuration) {
    ...
    public func sample(at elapsed: TUIDuration) -> AnimationSample {
        if elapsed >= duration {
    ...
    public func value(at elapsed: TUIDuration) -> Double {
...
extension Animation {
    ...
    func springMotionSample(at elapsed: TUIDuration) -> SpringMotionSample? {
    ...
    fileprivate static func springSettlingDuration(response: TUIDuration, dampingFraction: Double) -> TUIDuration {
    ...
    fileprivate func springMotionSample(
        ...
        return SpringMotionSample(
            ...
            initialVelocityVelocityScale: (
                firstRoot * firstExponential - secondRoot * secondExponential
            ) / denominator
        )
    }
}
