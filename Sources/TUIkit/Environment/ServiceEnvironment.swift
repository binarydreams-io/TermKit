...
// MARK: - Interaction Dispatcher

/// Environment key for mouse interaction registration and dispatch.
private struct InteractionDispatcherKey: EnvironmentKey {
    static let defaultValue: InteractionDispatcher? = nil
}
...
extension EnvironmentValues {
    ...
    /// Mouse interaction registration for the current runtime.
    var interactionDispatcher: InteractionDispatcher? {
        get { self[InteractionDispatcherKey.self] }
        set { self[InteractionDispatcherKey.self] = newValue }
    }
