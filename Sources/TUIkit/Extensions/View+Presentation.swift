...
extension View {
    ...
    ///
    /// - Parameters:
    ///   - width: Fixed width of each notification in characters (default: 40).
    ///   - surface: How each notification is painted (default: ``NotificationSurface/bordered``).
    /// - Returns: A view that renders notifications from the environment service.
    public func notificationHost(
        width: Int = 40,
        surface: NotificationSurface = .bordered
    ) -> some View {
