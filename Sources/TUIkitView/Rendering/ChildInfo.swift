...
@MainActor
public func makeChildInfo(for view: some View, context: RenderContext) -> ChildInfo {
  if let spacer = view as? SpacerProtocol {
...
@MainActor
public func renderChild(_ view: some View, width: Int, height: Int, context: RenderContext) -> FrameBuffer {
