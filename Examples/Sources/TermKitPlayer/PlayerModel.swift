...
final class PlayerModel {
    ...
    var currentTrack: PlayerTrack { tracks[currentTrackIndex] }
    var selectedTrack: PlayerTrack { tracks[selectedTrackIndex] }
    ...
    func play() {
        ...
        if positionAtAnchor >= currentTrack.duration { positionAtAnchor = .zero }
    ...
    func seek(by offset: TimeSpan) {
        ...
        if isPlaying { playbackAnchor = timeSource.now }
    }
